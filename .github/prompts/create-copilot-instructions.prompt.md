...
- File naming convention: lowercase with hyphens, for example: [NAME].instructions.md
...
- **description**: Double-quoted string, 1-500 characters, clearly stating the purpose
