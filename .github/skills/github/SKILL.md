---
name: github
description: 'Design, write, and review GitHub Actions workflow YAML files. USE FOR: creating .github/workflows/*.yml files; CI build/test/lint jobs; Docker image builds and pushes; deployment jobs; secret management with GITHUB_TOKEN and OIDC; caching npm/pnpm/NuGet/pip dependencies; matrix strategies; reusable workflows (workflow_call); dependency review and CodeQL SAST scans; concurrency controls; self-hosted runners. DO NOT USE FOR: Azure DevOps pipelines (use the azure skill); local development tasks. Keywords: github actions, workflow, jobs, steps, actions/checkout, secrets, OIDC, cache, matrix, environment, deploy, CI, CD, artifact.'
---
