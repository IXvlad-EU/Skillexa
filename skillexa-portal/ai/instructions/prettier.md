...
Build artifacts, dependencies, lock files, and **generated OpenAPI types** (`lib/api-client/`) are excluded from formatting. Never format auto-generated code.
...
- **Generated OpenAPI types** (`lib/api-client/`): excluded via `.prettierignore`. Never manually format them.
