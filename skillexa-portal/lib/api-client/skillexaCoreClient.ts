...
export function createSkillexaCoreClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SkillexaCoreClient>(requestAdapter, pathParameters, undefined, SkillexaCoreClientRequestsMetadata);
}
/**
...
export interface SkillexaCoreClient extends BaseRequestBuilder<SkillexaCoreClient> {
    /**
     * Returns a greeting message from Skillexa-Core
 ...
 */
export const SkillexaCoreClientRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: SkillexaCoreClientUriTemplate,
