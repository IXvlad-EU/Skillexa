...
Use when a user asks to create, update, validate, or troubleshoot Mermaid diagrams for architecture, request flows, sequence flows, async processing, or Markdown documentation rendering compatibility.
